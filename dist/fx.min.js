...
function(a){clearTimeout(a)}})(window);window.performance=window.performance||{};performance.now=function(){return performance.now||performance.mozNow||performance.msNow||performance.oNow||performance.webkitNow||function(){return(new Date).getTime()}}();Object.create||(Object.create=function(a){function b(){}if(1<arguments.length)throw Error("Object.create implementation only accepts the first parameter.");b.prototype=a;return new b});(function(a){var b={provide:function(a){a=a.split(".");var b=this,e,f;"fx"===a[0]&&(a=a.slice(1));e=a.length;for(f=0;f<e;f++)"undefined"==typeof b[a[f]]&&(b[a[f]]={}),b=b[a[f]];return b},getType:function(a){return b.Type.get(a)},hasClass:function(a,b){if(!a)throw Error("fx.hasClass: Too few arguments.");return a.className.match(RegExp("(\\s|^)"+b+"(\\s|$)"))},addClass:function(a,d){if(!a||!d)throw Error("fx.addClass: Too few arguments.");b.hasClass(a,d)||(d=d.replace(/(^\s+|\s+$)/g,""),a.className=
a.className.replace(/(^\s+|\s+$)/g,""),a.className+=" "+d)},removeClass:function(a,d){if(!a||!d)throw Error("fx.removeClass: Too few arguments.");b.hasClass(a,d)&&(a.className=a.className.replace(RegExp("(\\s|^)"+d+"(\\s|$)")," "),a.className=a.className.replace(/(^\s+|\s+$)/g,""))},swapClass:function(a,d,e){if(!a||!d||!e)throw Error("fx.swapClass: Too few arguments.");b.removeClass(a,d);b.addClass(a,e)},documentReady:function(a,b){var e=!1,f=!0,g=a.document,h=g.documentElement,k=g.addEventListener?
"addEventListener":"attachEvent",q=g.addEventListener?"removeEventListener":"detachEvent",m=g.addEventListener?"":"on",l=function(f){if(!("readystatechange"==f.type&&"complete"!=g.readyState)&&(("load"==f.type?a:g)[q](m+f.type,l,!1),!e&&(e=!0)))b.call(a,f.type||f)},p=function(){try{h.doScroll("left")}catch(a){setTimeout(p,50);return}l("poll")};if("complete"==g.readyState)b.call(a,"lazy");else if(g.createEventObject&&h.doScroll){try{f=!a.frameElement}catch(r){}f&&p()}g[k](m+"DOMContentLoaded",l,!1);
g[k](m+"readystatechange",l,!1);a[k](m+"load",l,!1)}};a.fx=b})(window);fx.ArrayIterator=function(a){if(!(this instanceof arguments.callee))throw Error("Constructor called as a function.");if(a&&"[object Array]"!==Object.prototype.toString.apply(a))throw new TypeError("fx.ArrayIterator expected data type Array for argument 'data'.");this.data=a||[];this.index=-1};
