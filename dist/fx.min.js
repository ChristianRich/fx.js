...
fx.HashMap.prototype={add:function(a,b){this.dict[a]=b;this.keys.push(a)},get:function(a){return this.contains(a)?this.dict[a]:null},contains:function(a){return!!this.dict[a]},random:function(){if(0===this.getSize())return null;var a=Math.floor(Math.random()*this.keys.length);return this.get(this.keys[a])},"delete":function(a){if(!this.contains(a))return!1;delete this.dict[a];a=this.keys.indexOf(a);this.keys.splice(a,1);return!0},flush:function(){for(var a in this.dict)delete this.dict[a];this.dict=
{};this.keys=[]},getSize:function(){return this.keys.length},dump:function(){var a=this.toString()+" contains:\n",b;for(b in this.dict)a+="\nkey: "+b+", value: "+this.dict[b];return a},toString:function(){return"[HashMap] size: "+this.getSize()}};fx.Stack=function(a){if(!(this instanceof arguments.callee))throw Error("Constructor called as a function.");this._capacity=a||Number.MAX_VALUE;this._queue=[]};
...
fx.Queue.prototype={push:function(a){this._queue.length+1>this._capacity&&this.pop();this._queue.push(a)},pop:function(){return this._queue.shift()},peek:function(){return this._queue[0]},search:function(a){return this._queue.length&&i<this._queue.length?this._queue[a]:null},getSize:function(){return this._queue.length},getCapacity:function(){return this._capacity},isFull:function(){return this._queue.length==this._capacity},empty:function(){return!!this._queue.length},dump:function(){for(var a=this.toString()+
" contains:\n",b=0;b<this._queue.length;b++)a+="\nvalue: "+this._queue[b];return a},toArray:function(){return this._queue},toString:function(){var a="[Queue] size: "+this._queue.length;this._capacity!==Number.MAX_VALUE&&(a+=", capacity: "+this._capacity);return a}};fx.Element=function(a){this.css=function(a){for(var b in a)this.domElement.style[b]=a[b];return this};this.opacity=function(a){this.css({"-ms-filter":"progid:DXImageTransform.Microsoft.Alpha(Opacity="+100*a+"')",filter:"alpha(opacity="+100*a+")","-moz-opacity":a,"-khtml-opacity":a,opacity:a});return this};this.html=function(a){this.innerHTMLappend+=a;return this};this.exec=function(){this.innerHTMLappend&&(this.domElement.innerHTML+=this.innerHTMLappend,this.innerHTMLappend="");return this};this.clearCSS=
