...
this.end)},equals:function(a){return this.start===a.start&&this.end===a.end},toString:function(){return"[Range] start: "+this.start+", end: "+this.end}};fx.Oscillator=function(a,b,c,d){this.start=a||0;this.end=b||1;this.step=c||0.1;this.reverse=d;this.value=a;void 0===this.reverse&&(this.reversed=!1)};
fx.Oscillator.prototype={update:function(){this.value+=this.step;this.value>=this.end?this.reverse?this.step=-this.step:this.reset():this.value<=this.start&&(this.step=Math.abs(this.step),this.value=this.start)},step:function(a){},hasNext:function(){return this.reverse?!0:this.value+this.step<=this.end},toRange:function(){return new fx.Range(this.min,this.max)},getNumSteps:function(){return Math.abs(this.end-this.start)/this.step},reset:function(){this.value=this.start},toString:function(){return"[Oscillator] value: "+
...
~~k+"px";a.style.left=~~h+"px"}};fx.DelayCall=function(a,b,c){if(!(this instanceof arguments.callee))throw Error("Constructor called as a function.");if(!b)throw Error("Missing required parameter time.");if(!a)throw Error("Missing required parameter callback.");c=c||window;var d=!1,e=setTimeout(function(){a&&(a.call(c),a=null);d=!0},b);this.cancel=function(){e&&!d&&(clearTimeout(e),a=e=null)}};fx.Keycode={BACKSPACE:8,TAB:9,ENTER:13,COMMAND:15,SHIFT:16,CONTROL:17,ALTERNATE:18,PAUSE:19,CAPS_LOCK:20,NUMPAD:21,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DELETE:46,NUMBER_0:48,NUMBER_1:49,NUMBER_2:50,NUMBER_3:51,NUMBER_4:52,NUMBER_5:53,NUMBER_6:54,NUMBER_7:55,NUMBER_8:56,NUMBER_9:57,A:65,B:66,C:67,D:68,E:69,F:70,G:71,H:72,I:73,J:74,K:75,L:76,M:77,N:78,O:79,P:80,Q:81,R:82,S:83,T:84,U:85,V:86,W:87,X:88,Y:89,Z:90,LEFT_WINDOW_KEY:91,RIGHT_WINDOW_KEY:92,
