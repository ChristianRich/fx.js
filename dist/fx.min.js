...
fx.Oscillator.prototype={update:function(){this.value+=this.step;this.value>=this.end?this.reverse?this.step=-this.step:this.reset():this.value<=this.start&&(this.step=Math.abs(this.step),this.value=this.start);return this.value},hasNext:function(){return this.reverse?!0:this.value+this.step<=this.end},toRange:function(){return new fx.Range(this.min,this.max)},getNumSteps:function(){return Math.abs(this.end-this.start)/this.step},reset:function(){this.value=this.start},toString:function(){return"[Oscillator] value: "+
