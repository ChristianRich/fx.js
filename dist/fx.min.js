...
isFull:function(){return this._queue.length==this._capacity},isEmpty:function(){return!!this._queue.length},dump:function(){for(var a=this.toString()+" contains:\n",b=0;b<this._queue.length;b++)a+="\nvalue: "+this._queue[b];return a},flush:function(){this._queue=[]},toArray:function(){return this._queue},toString:function(){var a="[Queue] size: "+this._queue.length;this._capacity!==Number.MAX_VALUE&&(a+=", capacity: "+this._capacity);return a}};fx.Sequencer=function(a,b){if(!(this instanceof arguments.callee))throw Error("Constructor called as a function.");if(!a)throw Error("Too few arguments.");this.size=a;this.index=-1;this.data=[];for(var c=b||0;c<this.size;c++)this.data[c]=c;return this};
...
a+b.y}},getPointInCircle:function(a,b){return{x:Math.cos(b)*a,y:Math.sin(b)*a}},getCircumferencePoint:function(a,b,c){a-=c;b-=c;var d=Math.sqrt(c*c/(1+a*a/(b*b)));c=Math.sqrt(c*c-d*d);return 0<a&&0<b?{x:c,y:d}:0>a&&0>b?{x:-c,y:-d}:0>a&&0<b?{x:-c,y:d}:0<a&&0>b?{x:c,y:-d}:{x:c,y:d}}};fx.Line=function(a,b){if(!(this instanceof arguments.callee))throw Error("Constructor called as a function.");if(!fx.Point.IsPoint(a)||!fx.Point.IsPoint(b))throw Error("Argument a and b must be fx.Point objects.");this.reset(a,b)};
...
", tick: "+this.tick}};fx.Renderer=function(a){if(!window.performance.now)throw Error("fx.Renderer depends on the window.performance.now() polyfill.");if(!window.requestAnimationFrame||!window.cancelAnimationFrame)throw Error("fx.Renderer depends on requestAnimationFrame / cancelAnimationFrame polyfill.");var b=!1,c=0,d=this;this.frame=0;this.ms=Infinity;this.MIN_DELTA=160;this.start=function(){b||(c=0,b=!0,d.frame=requestAnimationFrame(a))};this.stop=function(){b&&(b=!1,cancelAnimationFrame(d.frame))};this.update=function(){if(b){var d=
performance.now();this.ms=d-c;c=d;this.frame=requestAnimationFrame(a)}};this.toggle=function(){if(b)return this.stop(),!1;this.start();return!0};this.getFps=function(){return Infinity===this.ms?Infinity:Math.round(1E3/this.ms)};this.isRendering=function(){return b};this.pauseOnBlur=function(a){a?(window.addEventListener("focus",self.start,!1),window.addEventListener("blur",self.stop,!1)):(window.removeEventListener("focus",self.start,!1),window.removeEventListener("blur",self.stop,!1))}};fx.PrecisionTimer=function(a,b,c){if(this instanceof arguments.callee)if(a){if(isNaN(a))throw Error("Parameter 'duration' is not a Number.");if(!b)throw Error("Missing required parameter 'notify'.");}else throw Error("Missing required parameter 'duration'.");else throw Error("Constructor called as a function.");this.duration=a;this.notify=b;this.useFrames=c||!1;this.requestId=0;this.paused=this.running=!1;this.ms=Infinity;this.count=this.currentFrame=this.currentTime=0;this.maxDeltaTime=160;var d,
e=this;this._callback=function(){e.currentTime=e.duration;e.count++;e.lastTime=0;e.reset();e.notify.call(e)};this._tick=function(){if(e.running&&!e.paused){e.useFrames?e.currentFrame==e.duration&&e._callback.call(this.context||e):e.currentTime>=e.duration&&e._callback.call(this.context||e);e.onTick&&e.onTick.call(this.context||e);var a=performance.now();e.ms=a-(d||a);e.ms>e.maxDeltaTime&&(e.ms=0);d=a;e.currentTime+=e.ms;e.currentFrame++;e.requestId=requestAnimationFrame(e._tick)}}};
fx.PrecisionTimer.prototype={start:function(){!this.running&&!this.paused&&(this.running=!0,this.requestId=requestAnimationFrame(this._tick))},stop:function(){this.running&&(this.paused=this.running=!1,this.reset(),cancelAnimationFrame(this.requestId))},pause:function(){!this.paused&&this.running&&(this.paused=!0)},resume:function(){this.paused&&(this.paused=!1,this.requestId=requestAnimationFrame(this._tick))},getFormattedTime:function(){return(this.currentTime/1E3).toFixed(2)},reset:function(){this.currentFrame=
this.currentTime=0},rafActive:function(){return this.ms<this.maxDeltaTime},destroy:function(){this.stop();this.duration=this.notify=null},bind:function(a){this.context=a;return this},toString:function(){var a="[PrecisionTimer] ",a=this.useFrames?a+("duration in frames: "+this.duration+", currentFrame: "+this.currentFrame):a+("duration in ms: "+this.duration+", currentTime: "+this.getFormattedTime());return a+=", count: "+this.count+", running: "+this.running+", paused: "+this.paused+", ms: "+this.ms.toFixed(2)}};fx.CanvasUtils={canvasToImage:function(a,b,c,d,e){if(!a)throw new TypeError("Not enough arguments");var f=new Image;f.src=fx.CanvasUtils.getBase64(a,b,c,d,e);return f},copy:function(a,b){if(!a||!b)throw new TypeError("Not enough arguments");b.getContext("2d").putImageData(fx.CanvasUtils.getImageData(a),0,0)},imageDataToImage:function(a,b){if(!a)throw new TypeError("Not enough arguments");var c=fx.CanvasUtils.getCanvas(a.width,a.height);c.getContext("2d").putImageData(a,0,0);if(b)b.src=fx.CanvasUtils.getBase64(c);
...
", height: "+this.height}}}};fx.CookieUtils={setItem:function(a,b,c){var d=parseInt(c)||365;c=new Date;c.setTime(c.getTime()+864E5*d);c="; expires="+c.toGMTString();return document.cookie=a+"="+b+c+"; path=/"},getItem:function(a){if("string"!==typeof a)throw Error("Invalid argument passed to fx.CookieUtils.getItem(). String expected.");return(a=document.cookie.match(RegExp(a+"=(.*?)(;|$)")))?a[1]:null},removeItem:function(a){if(!this.hasItem(a))return!1;document.cookie=a+"=;"+fx.CookieUtils.EXPIRES+"; path=/";return!0},hasItem:function(a){return!!this.getItem(a)},
getItemAsJSON:function(a){a=this.getItem(a);if(!a)return null;try{return JSON.parse(a)}catch(b){throw Error("fx.CookieUtils.getJSON(): parse error");}},setItemAsJSON:function(a,b){if("[object Object]"!==Object.prototype.toString.call(b))throw Error("fx.CookieUtils.setItemAsJSON(): [object Object] expected.");try{var c=JSON.stringify(b)}catch(d){throw Error("fx.CookieUtils.setItemAsJSON(): JSON parse error.");}return this.setItem(a,c)},flush:function(){for(var a=document.cookie.split(";"),b=0;b<a.length;b++){var c=
a[b],d=c.indexOf("="),c=-1<d?c.substr(0,d):c;document.cookie=c+"=;"+fx.CookieUtils.EXPIRES+"; path=/"}return!0},dump:function(){var a=document.cookie.split(";"),b;if(1==a.length&&0==a[0].length)return"No cookies found at "+document.URL;b=a.length.toString()+" cookie(s) found in "+document.URL;for(var c=0;c<a.length;c++){var d=a[c],e=d.split("=")[0],d=d.split("=")[1];b+="\n["+c.toString()+"] "+e+" = "+d}return b},getSize:function(){var a=document.cookie.split(";");if(1==a.length&&0==a[0].length)return 0;
for(var b=0,c=0;c<a.length;c++)b++;return b},toString:function(){return"fx.CookieUtils"}};fx.CookieUtils.EXPIRES="expires=Thu, 01 Jan 1970 00:00:00 GMT";fx.Date={daysBetween:function(a,b){return(a.valueOf()-b.valueOf())/1E3/60/60/24},isBefore:function(a,b){return!!(0>this.daysBetween(a,b))},isAfter:function(a,b){return!!(0<this.daysBetween(a,b))},isBetween:function(a,b,c){return!this.isBefore(a,b)&&!this.isAfter(a,c)},today:function(){return new Date},tomorrow:function(){return fx.Date.today().setDate(fx.Date.today().getDate()+1)},yesterday:function(a){return fx.Date.today().setDate(fx.Date.today().getDate()-1)},getMeridiem:function(a){return 12>
...
QUOTE:222};fx.LocalStorageUtils={supports:function(){try{return"localStorage"in window&&null!==window.localStorage}catch(a){return!1}},getItem:function(a){return localStorage.getItem(a)},setItem:function(a,b){localStorage.setItem(a,b);return a},removeItem:function(a){if(!this.hasItem(a))return!1;localStorage.removeItem(a);return!0},hasItem:function(a){return!!this.getItem(a)},getItemAsJSON:function(a){a=this.getItem(a);if(!a)return null;try{return JSON.parse(a)}catch(b){throw Error("fx.LocalStorageUtils.getItemAsJSON(): parse error");
}},setItemAsJSON:function(a,b){if("[object Object]"!==Object.prototype.toString.call(b))throw Error("fx.LocalStorageUtils.setItemAsJSON(): [object Object] expected.");try{var c=JSON.stringify(b)}catch(d){throw Error("fx.LocalStorageUtils.setItemAsJSON(): JSON parse error.");}return this.setItem(a,c)},flush:function(){localStorage.clear();return!0},dump:function(){var a=this.getSize();if(!a)return"Local storage is empty.";var a=a+" keys / value pairs found in local storage:",b;for(b in localStorage)a+=
"\n"+b+": "+localStorage[b];return a},getSize:function(){var a=0,b;for(b in localStorage)a++;return a},toString:function(){return"fx.LocalStorageUtils"}};fx.Mouse={getPos:function(a){var b={x:NaN,y:NaN,event:null},c=a.target,d,e;if(!a||!a.target)return b;a.pageX||a.pageY?(d=a.pageX,e=a.pageY):(d=a.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,e=a.clientY+document.body.scrollTop+document.documentElement.scrollTop);d-=c.offsetLeft;e-=c.offsetTop;b.x=d;b.y=e;b.event=a;0>b.x&&(b.x=0);0>b.y&&(b.y=0);return b}};fx.Object={getKeys:function(a){var b=[],c;for(c in a)b.push(c);return b},getValues:function(a){var b=[],c;for(c in a)b.push(a[c]);return b},dump:function(a){var b="",c;for(c in a)a[c]&&(b+=c+": "+a[c]+", ");return b},length:function(a){var b=0,c;for(c in a)b++;return b},isEmpty:function(a){return 0===this.length(a)},isObject:function(a){return"[object Object]"===Object.prototype.toString.apply(a)},toHashMap:function(a){var b=[],c;for(c in a)b[c]=a[c];return b},toArray:function(a){var b=[],c;for(c in a)b.push(c),
b.push(a[c]);return b},toMultidimensionalArray:function(a){var b=[],c;for(c in a)b.push([c,a[c]]);return b},clone:function(a){var b={},c;for(c in a)b[c]=a[c];return b}};fx.QueryString={getValue:function(a){if(!a)return!1;var b=this.parse();return b[a]?b[a]:null},hasKey:function(a){return!!this.getValue(a)},getLength:function(){var a=this.parse(),b=0,c;for(c in a)b++;return b},dump:function(){var a=this.getLength(),b,c;if(0==a)return"No query string found in url";b="Query string contains "+a+" key / value pairs:\n";a=this.parse();c=0;for(var d in a)a[d]&&(b+="["+c.toString()+"] "+d+": "+a[d]+"\n",c++);return b},parse:function(){var a={},b=location.search.substring(1).split("&"),
c;for(c in b){var d=b[c].split("=");1<d.length&&(a[decodeURIComponent(d[0].replace(/\+/g," "))]=decodeURIComponent(d[1].replace(/\+/g," ")))}return a}};fx.String={trim:function(a){return a.replace(/^\s*/,"").replace(/\s*$/,"")},startsWith:function(a,b){return this.isEmpty(a)?!1:0==a.indexOf(b)},endsWith:function(a,b){return this.isEmpty(a)||this.isEmpty(b)?!1:a.lastIndexOf(b)==a.length-b.length},isEmpty:function(a){return this.isString&&0<a.length},isString:function(a){return"[object String]"===Object.prototype.toString.apply(o)},isDigit:function(a){this.isString(a)||(a=a.toString());return a.test(/^\d*$/)},contains:function(a,b){return b&&-1!=b.indexOf(a)},
removeWhitespace:function(a){return a.replace(/\s/g,"")},insertAt:function(a,b,c){return a.substring(0,c)+b+a.substring(c)},toTitleCase:function(a){var b=a.substring(0,1).toUpperCase();1<a.length&&(b+=a.substring(1));return b},formatNumber:function(a){a=a.toString();var b=a.split(".");a=b[0];for(var b=1<b.length?"."+b[1]:"",c=/(\d+)(\d{3})/;c.test(a);)a=a.replace(c,"$1,$2");return a+b},cacheBuster:function(a,b){return b?a:a+"?noCache="+Math.round(1E5*Math.random()*(new Date).getMilliseconds())},catches:function(a,
b,c){c=3<=arguments.length?c:!1;b=this.trim(b);b=b.replace(/\s+/,"*");b=b.replace(/\*/,".*?");b=b.replace(/\?/,".{0,1}");return RegExp("^"+b,c?"i":"").test(a)},toTimeCode:function(a){var b=Math.floor(a/3600),c=Math.floor(a%3600/60);a=Math.floor(a%3600%60);return(0==b?"":10>b?"0"+b.toString()+":":b.toString()+":")+(10>c?"0"+c.toString():c.toString())+":"+(10>a?"0"+a.toString():a.toString())}};fx.System={touch:function(){return"createTouch"in document},canvas:function(){try{return!!document.createElement("canvas").getContext}catch(a){return!1}},webgl:function(){if(!this.canvas())return!1;for(var a=["webgl","experimental-webgl","moz-webgl","webkit-3d"],b=document.createElement("canvas"),c,d=0;d<a.length;d++)try{if(c=b.getContext(a[d]))return!0}catch(e){}return!1},html5Video:function(){return!!document.createElement("video").canPlayType},html5Audio:function(){return!!document.createElement("audio").canPlayType},
