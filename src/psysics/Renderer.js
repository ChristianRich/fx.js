	...
	*/
	...
	this.pauseOnBlur = function(flag){
		if(!(!!window.addEventListener)){
			console.warn('fx.Renderer: addEventListener not supported.');
		}
		...
		if(flag){
			...
			window.removeEventListener('focus', this.start, false);
			window.removeEventListener('blur', this.stop, false);
		}
	}
}